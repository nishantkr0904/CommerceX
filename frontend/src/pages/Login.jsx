...
const login = () => {
  ...
  // to prevent page reload on submiting the form
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      <div className='w-full flex justify-between text-sm mt-[-8px]'>
        ...
        {
          currentState === 'Login' 
          ? <p onClick={()=>setCurrentState('Sign Up')} p className='cursor-pointer'>Create account</p>
          : <p onClick={()=>setCurrentState('Login')} p className='cursor-pointer'>Login here</p>
        }
      </div>
